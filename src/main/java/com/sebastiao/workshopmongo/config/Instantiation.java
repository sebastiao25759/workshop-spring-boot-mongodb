package com.sebastiao.workshopmongo.config;

import com.sebastiao.workshopmongo.domain.Post;
import com.sebastiao.workshopmongo.domain.User;
import com.sebastiao.workshopmongo.dto.AuthorDTO;
import com.sebastiao.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("22/23/2018"), new AuthorDTO(bob));
